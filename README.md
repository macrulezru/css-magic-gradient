...
GitHub: [macrulezru](https://github.com/macrulezru) · Website: [npm.vuecraft.ru/en/](https://npm.vuecraft.ru/en/packages/css-magic-gradient/)

Bugs and questions — [issues](https://github.com/macrulezru/css-magic-gradient/issues)
